...
public class TaiKhoanDAO {
    ...
    public List<TaiKhoan> layTatCa() {
        ...
        try {
            ...
            // Đã thêm nv.trangThaiHoatDong vào truy vấn
            String truyVan = "SELECT tk.*, nv.tenNhanVien, nv.chucVu, nv.trangThaiHoatDong " +
    ...
    private TaiKhoan parseTaiKhoan(ResultSet rs) throws SQLException {
        ...
        // Lấy thêm trạng thái hoạt động của nhân viên
        nv.setTrangThai(rs.getBoolean("trangThaiHoatDong")); 
