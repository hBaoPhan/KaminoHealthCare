...
('OTC-CAL-016', N'Calcid Soft', N'OTC', 0, N'Canxi mềm bổ sung xương', N'Calcium', 1480, 1, 5),
('OTC-COR-017', N'Calcium Corbiere Kids', N'OTC', 0, N'Canxi cho trẻ em Extra Sanofi', N'Calcium', 165000, 1, 5),
('OTC-CST-018', N'Calcium Stada 500mg', N'OTC', 0, N'Canxi Stada bổ sung xương', N'Calcium Carbonate 500mg', 920, 1, 5),
('OTC-KID-019', N'KiddieCal Catalent', N'OTC', 0, N'Canxi cho trẻ em', N'Calcium', 135000, 1, 5),
('OTC-XKH-020', N'Xương Khớp Trương Phúc', N'OTC', 0, N'Hỗ trợ xương khớp', N'Glucosamine & Chondroitin', 2100, 1, 5),
('ETC-BET-019', N'Betamethason 0.064% Medipharco', N'ETC', 0, N'Corticoid bôi da điều trị viêm da', N'Betamethason 0.064%', 85000, 1, 10),
('ETC-DEX-020', N'Dexamethasone', N'ETC', 3000, N'Thuốc chống viêm, dị ứng mạnh', N'Dexamethasone', 650, 1, 10),
('ETC-MAX-021', N'Maxx Acne AC Ampharco', N'ETC', 0, N'Thuốc trị mụn nặng isotretinoin', N'Isotretinoin', 320000, 0, 10),
('ETC-SRI-022', N'Srinron 10g Mipharco', N'ETC', 0, N'Kem trị viêm da, eczema', N'Betamethason + Gentamicin', 95000, 1, 10),
('ETC-TOM-023', N'Tomax Genta Detapharm', N'ETC', 0, N'Kem kháng sinh da', N'Gentamicin', 78000, 1, 10),
('ETC-BIL-024', N'Bilaxiten 20mg Menarini', N'ETC', 0, N'Thuốc chống dị ứng', N'Bilastine 20mg', 1150, 1, 10),
('ETC-LOD-025', N'Lodax 20mg', N'ETC', 0, N'Thuốc chống dị ứng', N'Loratadine 20mg', 920, 1, 10),
('ETC-RUP-026', N'Rupafin 10mg', N'ETC', 0, N'Thuốc chống dị ứng', N'Rupatadine 10mg', 1050, 1, 10),
('ETC-RUT-027', N'Rutadin 10mg', N'ETC', 0, N'Thuốc chống dị ứng', N'Rupatadine', 980, 1, 10),
('ETC-ZYR-028', N'Zyrtec GSK', N'ETC', 0, N'Thuốc chống dị ứng', N'Cetirizine', 880, 1, 10),
('ETC-ZYR-029', N'Zyrtec GSK', N'ETC', 0, N'Thuốc chống dị ứng', N'Cetirizine', 880, 1, 10),
('ETC-CLE-029', N'Cledomox 625 Tenamyd', N'ETC', 0, N'Kháng sinh Amoxicillin/Clavulanic acid', N'Amoxicillin 625mg', 1350, 1, 10),
('ETC-FLU-030', N'Flucona-Denk 150mg', N'ETC', 0, N'Thuốc trị nấm', N'Fluconazole 150mg', 125000, 1, 10),
('ETC-IME-031', N'Imexime 100 Imexpharm', N'ETC', 0, N'Kháng sinh Cefixime', N'Cefixime 100mg', 950, 1, 10),
('ETC-IME-032', N'Imexime 200 Imexpharm', N'ETC', 0, N'Kháng sinh Cefixime', N'Cefixime 200mg', 1450, 1, 10),
('ETC-LEC-033', N'Lecifex 500mg Abbott', N'ETC', 0, N'Kháng sinh Levofloxacin', N'Levofloxacin 500mg', 1680, 1, 10),
('ETC-FEB-034', N'Febuxotid VK 40mg', N'ETC', 0, N'Điều trị gout', N'Febuxostat 40mg', 1950, 1, 10),
('ETC-FEB-035', N'Febuxotid VK 80mg', N'ETC', 0, N'Điều trị gout', N'Febuxostat 80mg', 2450, 1, 10),
('ETC-MET-036', N'Methocarbamol 500mg Khapharco', N'ETC', 0, N'Thuốc giãn cơ', N'Methocarbamol 500mg', 1150, 1, 10),
('ETC-OPE-037', N'Opedulox 40 OPV', N'ETC', 0, N'Thuốc giảm đau thần kinh', N'Duloxetine 40mg', 1780, 1, 10),
('ETC-OPE-038', N'Opedulox 80 OPV', N'ETC', 0, N'Thuốc giảm đau thần kinh', N'Duloxetine 80mg', 2250, 1, 10),
('TPCN-BPK-039', N'Bio Plus Kenko', N'TPCN', 500, N'Bổ sung vitamin và khoáng chất tổng hợp', N'Multi Vitamin & Minerals', 1950, 1, 10),
('TPCN-BNI-040', N'Bổ Não Ích Trí Gold', N'TPCN', 0, N'Bổ não, tăng cường trí nhớ', N'Ginkgo Biloba & Thảo dược', 2450, 1, 10),
('TPCN-BPL-041', N'Bổ Phế Labebe', N'TPCN', 0, N'Bổ phế, hỗ trợ hô hấp', N'Thảo dược', 168000, 1, 10),
('TPCN-CDK-042', N'Canxi D3 K2 Kingphar', N'TPCN', 220, N'Canxi kết hợp Vitamin D3 và K2', N'Calcium, Vitamin D3, K2', 1750, 1, 10),
('TPCN-D3D-043', N'D3 Drops DAO Nordic Health', N'TPCN', 0, N'Vitamin D3 dạng giọt', N'Vitamin D3', 135000, 1, 10),
('TPCN-HPM-044', N'High Potency MK-7 Drops', N'TPCN', 0, N'Vitamin K2 MK-7 cao cấp', N'Vitamin K2 MK-7', 225000, 1, 10),
('TPCN-HHT-045', N'Hoạt Huyết Thống Mạch Gold TW3', N'TPCN', 0, N'Hoạt huyết thông mạch', N'Thảo dược', 265000, 1, 10),
('TPCN-IMU-046', N'Immuvita Easylife', N'TPCN', 0, N'Tăng cường sức đề kháng', N'Vitamin & Immuno Support', 1890, 1, 10),
('TPCN-KAN-047', N'Kanzo Gold', N'TPCN', 0, N'Bổ gan Kanzo', N'Thảo dược', 198000, 1, 10),
('TPCN-KID-048', N'KID GROW Kenko', N'TPCN', 0, N'Vitamin tăng trưởng cho trẻ em', N'Multi Vitamin', 172000, 1, 10),
('TPCN-LBG-049', N'Lacto Biomin Gold', N'TPCN', 0, N'Men vi sinh Biomin', N'Probiotics', 168000, 1, 10),
('TPCN-LAC-050', N'Lactobact Intima 30V', N'TPCN', 0, N'Men vi sinh phụ khoa', N'Lactobacillus', 2450, 1, 10),
('TPCN-NUT-051', N'NutriGrow Nutrimed', N'TPCN', 0, N'Bổ sung dinh dưỡng trẻ em', N'Multi Vitamin', 165000, 1, 10),
('TPCN-OMP-052', N'Omega 3 Plus Kenko', N'TPCN', 0, N'Omega 3 cao cấp', N'Omega-3 Fish Oil', 2350, 1, 10),
('TPCN-OPD-053', N'Omega 3 Power DAO Nordic Health', N'TPCN', 0, N'Omega 3 Nordic Health', N'Omega-3', 258000, 1, 10),
('TPCN-OMX-054', N'Omexxel 3-6-9 Premium', N'TPCN', 0, N'Omega 3-6-9 Premium', N'Omega 3,6,9', 275000, 1, 10),
('TPCN-OMG-055', N'Omexxel Ginkgo 120 Premium', N'TPCN', 300, N'Ginkgo Biloba 120mg', N'Ginkgo Biloba', 2450, 1, 10),
('TPCN-PIK-056', N'Pikolin Ocavill', N'TPCN', 0, N'Sắt Pikolin dễ hấp thu', N'Iron Pikolin', 1980, 1, 10),
('TPCN-POB-057', N'Premium Omexxel Bone Health', N'TPCN', 0, N'Hỗ trợ xương khớp cao cấp', N'Calcium + Vitamin D & K2', 2890, 1, 10),
('TPCN-SKI-058', N'SkillMax Ocavill', N'TPCN', 0, N'Hỗ trợ trí não', N'Ginkgo & Phosphatidylserine', 2150, 1, 10),
