CREATE DATABASE [QuanLyHieuThuocKaminoHealthcare];
GO

USE [QuanLyHieuThuocKaminoHealthcare];
GO
...
CREATE TABLE NhanVien (
    ...
    trangThai BIT -- 1: Đang làm, 0: Nghỉ
);
...
CREATE TABLE DonViQuyDoi (
    maDonViQuyDoi VARCHAR(20) PRIMARY KEY,
...
CREATE TABLE ChiTietHoaDon (
    ...
    maDonViQuyDoi VARCHAR(20) FOREIGN KEY REFERENCES DonViQuyDoi(maDonViQuyDoi),
    soLuong INT,
    donGia FLOAT,
    laQuaTangKem BIT DEFAULT 0,
    PRIMARY KEY (maHoaDon, maDonViQuyDoi)
);
...
CREATE TABLE SuPhanBoLo (
    ...
    CONSTRAINT FK_SuPhanBoLo_ChiTiet 
        ...
        REFERENCES ChiTietHoaDon(maHoaDon, maDonViQuyDoi),
