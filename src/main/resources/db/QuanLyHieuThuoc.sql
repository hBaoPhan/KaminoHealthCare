...
VALUES (
        ...
        N'OTC',
        998,
        N'Kem trị bỏng, vết thương và bỏng nắng',
        N'Biafine',
        95000,
        1,
        5
    ...
    (
        ...
        N'OTC',
        100,
        N'Dung dịch trị rụng tóc Minoxidil',
        N'Minoxidil 20mg',
        185000,
        1,
        5
    ...
    (
        'OTC-REM-005',
        N'Remowart Farmalabor',
        N'OTC',
        0,
        N'Thuốc bôi trị mụn cóc, u mềm',
        N'Acid Salicylic',
        98000,
        1,
        5
    ...
    (
        ...
        N'OTC',
        795,
        N'Thuốc chống dị ứng thế hệ mới',
        N'Fexofenadine',
        850,
        1,
        5
    ...
    (
        'OTC-CLO-008',
        N'Clorpheniramin 4mg',
        N'OTC',
        0,
        N'Thuốc kháng histamine trị dị ứng',
        N'Chlorpheniramine',
        450,
        1,
        5
    ...
    (
        'OTC-ATS-011',
        N'Atsirox 1 An Thiên',
        N'OTC',
        0,
        N'Thuốc kháng sinh trị nhiễm khuẩn',
        N'Amoxicillin',
        750,
        1,
        5
    ...
    (
        'OTC-TRI-014',
        N'Thuốc trị vảy nến da đầu',
        N'OTC',
        0,
        N'Thuốc trị vảy nến da đầu',
        N'Coal Tar + Salicylic Acid',
        98000,
        1,
        5
    ),
    ...
    (
        'OTC-COR-017',
        N'Calcium Corbiere Kids',
        N'OTC',
        1000,
        N'Canxi cho trẻ em Extra Sanofi',
        N'Calcium',
        165000,
        1,
        5
    ...
    (
        'OTC-CST-018',
        N'Calcium Stada 500mg',
        N'OTC',
        1000,
        N'Canxi Stada bổ sung xương',
        N'Calcium Carbonate 500mg',
        920,
        1,
        5
    ),
    ...
    (
        'ETC-BET-019',
        N'Betamethason 0.064% Medipharco',
        N'ETC',
        500,
        N'Corticoid bôi da điều trị viêm da',
        N'Betamethason 0.064%',
        85000,
        1,
        10
    ),
    (
        ...
        N'ETC',
        3000,
        N'Thuốc chống viêm, dị ứng mạnh',
        N'Dexamethasone',
        650,
        1,
        10
    ...
    (
        'ETC-MAX-021',
        N'Maxx Acne AC Ampharco',
        N'ETC',
        500,
        N'Thuốc trị mụn nặng isotretinoin',
        N'Isotretinoin',
        320000,
        0,
        10
    ...
    (
        'ETC-SRI-022',
        N'Srinron 10g Mipharco',
        N'ETC',
        500,
        N'Kem trị viêm da, eczema',
        N'Betamethason + Gentamicin',
        95000,
        1,
        10
    ),
    ...
    (
        'ETC-CLE-029',
        N'Cledomox 625 Tenamyd',
        N'ETC',
        500,
        N'Kháng sinh Amoxicillin/Clavulanic acid',
        N'Amoxicillin 625mg',
        1350,
        1,
        10
    ...
    (
        'ETC-IME-031',
        N'Imexime 100 Imexpharm',
        N'ETC',
        500,
        N'Kháng sinh Cefixime',
        N'Cefixime 100mg',
        950,
        1,
        10
    ...
    (
        'ETC-LEC-033',
        N'Lecifex 500mg Abbott',
        N'ETC',
        500,
        N'Kháng sinh Levofloxacin',
        N'Levofloxacin 500mg',
        1680,
        1,
        10
    ),
    ...
    (
        'ETC-MET-036',
        N'Methocarbamol 500mg Khapharco',
        N'ETC',
        500,
        N'Thuốc giãn cơ',
        N'Methocarbamol 500mg',
        1150,
        1,
        10
    ),
...
VALUES ('DV001', N'TUYP', 1, 'OTC-BIA-001', '8934567890123'),
    ('DV002', N'TUYP', 1, 'OTC-CON-002', NULL),
    ('DV003', N'CHAI', 1, 'OTC-MIN-003', NULL),
    ('DV004', N'CHAI', 1, 'OTC-NIZ-004', NULL),
    ('DV005', N'TUYP', 1, 'OTC-REM-005', NULL),
    ('DV006', N'CHAI', 1, 'OTC-CIC-013', NULL),
    ('DV007', N'TUYP', 1, 'ETC-BET-019', NULL),
    ('DV008', N'TUYP', 1, 'ETC-SRI-022', NULL),
    ('DV009', N'TUYP', 1, 'ETC-TOM-023', NULL),
    ('DV010', N'CHAI', 1, 'TPCN-D3D-043', NULL),
    ('DV011', N'CHAI', 1, 'TPCN-HPM-044', NULL),
    ('DV012', N'CHAI', 1, 'TPCN-LBG-049', NULL),
    ('DV013', N'CHAI', 1, 'TPCN-KAN-047', NULL),
    ('DV014', N'CHAI', 1, 'OTC-COR-017', NULL),
    ('DV015', N'VIEN', 1, 'OTC-ALL-006', '8931111111111'),
    ('DV016', N'VI', 10, 'OTC-ALL-006', '8932222222222'),
    ('DV017', N'HOP', 100, 'OTC-ALL-006', '8933333333333'),
    ('DV018', N'VIEN', 1, 'OTC-CET-007', NULL),
    ('DV019', N'VI', 10, 'OTC-CET-007', NULL),
    ('DV020', N'HOP', 100, 'OTC-CET-007', NULL),
    ('DV021', N'VIEN', 1, 'OTC-CLO-008', NULL),
    ('DV022', N'VI', 10, 'OTC-CLO-008', NULL),
    ('DV023', N'HOP', 100, 'OTC-CLO-008', NULL),
    ('DV024', N'VIEN', 1, 'OTC-EXO-009', NULL),
    ('DV025', N'VI', 10, 'OTC-EXO-009', NULL),
    ('DV026', N'HOP', 100, 'OTC-EXO-009', NULL),
    ('DV027', N'VIEN', 1, 'OTC-HIS-010', NULL),
    ('DV028', N'VI', 10, 'OTC-HIS-010', NULL),
    ('DV029', N'HOP', 100, 'OTC-HIS-010', NULL),
    ('DV030', N'VIEN', 1, 'OTC-ATS-011', NULL),
    ('DV031', N'VI', 10, 'OTC-ATS-011', NULL),
    ('DV032', N'HOP', 100, 'OTC-ATS-011', NULL),
    ('DV033', N'VIEN', 1, 'OTC-FUG-012', NULL),
    ('DV034', N'VI', 1, 'OTC-FUG-012', NULL),
    ('DV035', N'HOP', 1, 'OTC-FUG-012', NULL),
    ('DV036', N'VIEN', 1, 'ETC-DEX-020', NULL),
    ('DV037', N'VI', 10, 'ETC-DEX-020', NULL),
    ('DV038', N'HOP', 100, 'ETC-DEX-020', NULL),
    ('DV039', N'VIEN', 1, 'ETC-BIL-024', NULL),
    ('DV040', N'VI', 10, 'ETC-BIL-024', NULL),
    ('DV041', N'HOP', 30, 'ETC-BIL-024', NULL),
    ('DV042', N'VIEN', 1, 'ETC-LOD-025', NULL),
    ('DV043', N'VI', 10, 'ETC-LOD-025', NULL),
    ('DV044', N'HOP', 100, 'ETC-LOD-025', NULL),
    ('DV045', N'VIEN', 1, 'ETC-RUP-026', NULL),
    ('DV046', N'VI', 10, 'ETC-RUP-026', NULL),
    ('DV047', N'HOP', 30, 'ETC-RUP-026', NULL),
    ('DV048', N'VIEN', 1, 'ETC-CLE-029', NULL),
    ('DV049', N'VI', 7, 'ETC-CLE-029', NULL),
    ('DV050', N'HOP', 14, 'ETC-CLE-029', NULL),
    ('DV051', N'VIEN', 1, 'ETC-FLU-030', NULL),
    ('DV052', N'VI', 1, 'ETC-FLU-030', NULL),
    ('DV053', N'HOP', 1, 'ETC-FLU-030', NULL),
    ('DV054', N'VIEN', 1, 'ETC-IME-031', NULL),
    ('DV055', N'VI', 10, 'ETC-IME-031', NULL),
    ('DV056', N'HOP', 20, 'ETC-IME-031', NULL),
    ('DV057', N'VIEN', 1, 'ETC-FEB-034', NULL),
    ('DV058', N'VI', 10, 'ETC-FEB-034', NULL),
    ('DV059', N'HOP', 30, 'ETC-FEB-034', NULL),
    ('DV060', N'VIEN', 1, 'ETC-MET-036', NULL),
    ('DV061', N'VI', 10, 'ETC-MET-036', NULL),
    ('DV062', N'HOP', 50, 'ETC-MET-036', NULL),
    ('DV063', N'VIEN', 1, 'TPCN-BPK-039', NULL),
    ('DV064', N'VI', 10, 'TPCN-BPK-039', NULL),
    ('DV065', N'HOP', 60, 'TPCN-BPK-039', NULL),
    ('DV066', N'VIEN', 1, 'TPCN-BNI-040', NULL),
    ('DV067', N'VI', 10, 'TPCN-BNI-040', NULL),
    ('DV068', N'HOP', 30, 'TPCN-BNI-040', NULL),
    ('DV069', N'VIEN', 1, 'TPCN-CDK-042', NULL),
    ('DV070', N'VI', 10, 'TPCN-CDK-042', NULL),
    ('DV071', N'HOP', 30, 'TPCN-CDK-042', NULL),
    ('DV072', N'VIEN', 1, 'TPCN-OMP-052', NULL),
    ('DV073', N'VI', 15, 'TPCN-OMP-052', NULL),
    ('DV074', N'HOP', 60, 'TPCN-OMP-052', NULL),
    ('DV075', N'VIEN', 1, 'TPCN-OMG-055', NULL),
    ('DV076', N'VI', 10, 'TPCN-OMG-055', NULL),
    ('DV077', N'HOP', 30, 'TPCN-OMG-055', NULL),
    ('DV078', N'VIEN', 1, 'TPCN-POB-057', NULL),
    ('DV079', N'VI', 10, 'TPCN-POB-057', NULL),
    ('DV080', N'HOP', 30, 'TPCN-POB-057', NULL),
    ('DV081', N'VIEN', 1, 'OTC-CAL-016', NULL),
    ('DV082', N'VI', 10, 'OTC-CAL-016', NULL),
    ('DV083', N'HOP', 100, 'OTC-CAL-016', NULL),
    ('DV084', N'VIEN', 1, 'OTC-CST-018', NULL),
    ('DV085', N'VI', 10, 'OTC-CST-018', NULL),
    ('DV086', N'HOP', 100, 'OTC-CST-018', NULL),
    ('DV087', N'VIEN', 1, 'OTC-XKH-020', NULL),
    ('DV088', N'VI', 10, 'OTC-XKH-020', NULL),
    ('DV089', N'HOP', 60, 'OTC-XKH-020', NULL),
    ('DV090', N'VIEN', 1, 'TPCN-IMU-046', NULL),
    ('DV091', N'VI', 10, 'TPCN-IMU-046', NULL),
    ('DV092', N'HOP', 30, 'TPCN-IMU-046', NULL),
    ('DV093', N'VIEN', 1, 'TPCN-LAC-050', NULL),
    ('DV094', N'VI', 10, 'TPCN-LAC-050', NULL),
    ('DV095', N'HOP', 30, 'TPCN-LAC-050', NULL),
    ('DV096', N'VIEN', 1, 'TPCN-PIK-056', NULL),
    ('DV097', N'VI', 10, 'TPCN-PIK-056', NULL),
    ('DV098', N'HOP', 30, 'TPCN-PIK-056', NULL),
...
FROM SanPham sp
    INNER JOIN (
        ...
        SELECT maSanPham,
            SUM(soLuongSanPham) AS TongSoLuongMoi
        FROM inserted
        GROUP BY maSanPham
